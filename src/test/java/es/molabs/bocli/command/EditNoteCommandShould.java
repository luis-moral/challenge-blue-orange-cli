...
public class EditNoteCommandShould {
    ...
    print_note_edited_message() throws IOException {
        ...
        Mockito
            .when(webClient.post(ConsoleCommandParser.DEFAULT_HOST + "/api/creator/note/1", requestBody))
        ...
        Mockito
            ...
            .post(ConsoleCommandParser.DEFAULT_HOST + "/api/creator/note/1", requestBody);
